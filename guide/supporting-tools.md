While most [dev container properties](implementors/json_reference) apply to any
...
The Dev Containers extension implements the
...
You can customize which files are initially opened when the codespace is
created:
